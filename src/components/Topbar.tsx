...
export const Topbar: React.FC<TopbarProps> = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "flex items-center justify-between px-4 py-3 border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 relative z-50",
        className
      )}
    >
      {/* Status Indicator */}
